...
function Projects() {
  ...
  return (
    ...
    <div className="">
      <ContentContainer>
        <h4 className=" border border-black font-[600] font-outfit leading-10 text-3xl text-text-color ">
          My Last 3 projects
        </h4>
      </ContentContainer>
      ...
      <div className="mt-[22px]">
        {projectArray.map((each, i) => (
          <div key={i} className={` bg-${each.eachBg}`}>
            <ContentContainer>
              <div
                className={`flex flex-col gap-y-5 md:gap-y-0 md:justify-between  md:${
