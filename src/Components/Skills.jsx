      ...
      <div className=" lg:flex lg:justify-center lg:items-center gap-x-[72px] mt-[-30px]">
        ...
        <div className="px-6 py-10 lg:w-[650px]">
          ...
          <div className="shadow-custom pb-4 lg:pb-2">
            <div className="mt-6 pb-4   pt-4 px-4 rounded-[16px]  md:flex flex-wrap  gap-x-[40px] ">
              {skillsArray.map((each) => (
                <div key={each.skill} className="mt-3 lg:mt-2">
                  <h5 className="text-btn-text-color text-base font-quicksand leading-5 font-normal text-[14px]">
                    {each.skill}
                  </h5>
                  <div className="flex gap-3 items-center">
                    <div className="w-[262px] md:w-[500px] lg:w-[210px] relative border-btn-text-color  border h-[25px] py-[2px] pl-[2px] lg:pl-[1px] lg:pr-[1px] lg:h-[17px] lg:py-[1px]">
                      <div className="w-full bg-plain-white relative z-20 flex items-center gap-[2px] ">
                        {Array.from({ length: maxPercent }, (_, i) => (
                          <div
                            key={i}
                            className={`w-[26px] md:w-[500px]  lg:w-[21px] lg:h-[13px] bg-${
                              each.percent + 1 <= i + 1
                                ? "text-color-two"
                                : "blue-text"
                            }`}
                      ...
                      <div className="bg-plain-white w-[263px] md:w-[502px] lg:w-[210px] md:h-5  absolute z-10 bottom-[50%] lg:h-[3px] lg:bottom-[45%] flex justify-end">
